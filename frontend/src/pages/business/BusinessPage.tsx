      ...
      <div className="max-w-6xl mx-auto py-6 px-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Portofolio{" "}
            <span className="bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">Bisnis</span>{" "}
            Anda
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <div className="text-xs text-gray-600">Siap untuk Listing</div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          {loading ? (
            <div className="text-center py-8">
              ...
              <p className="mt-2 text-gray-600">Memuat bisnis Anda...</p>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Belum Ada Bisnis yang Siap</h3>
              ...
              >
                ...
                <span className="font-semibold">Buat Bisnis Baru</span>
              </Link>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  <div className="text-sm text-gray-500">
                    {businesses.length} {businesses.length === 1 ? "bisnis" : "bisnis"}
                  </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3 ml-4">
                          ...
                          <div className="flex space-x-1">
                            <div className="w-2 h-2 rounded-full bg-emerald-500" title="Lengkap"></div>
                            <div className="w-2 h-2 rounded-full bg-emerald-500" title="Terverifikasi"></div>
                            <div className="w-2 h-2 rounded-full bg-emerald-500" title="Siap"></div>
                          </div>
